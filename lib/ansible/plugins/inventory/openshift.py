      ...
      connections:
          ...
          api_key:
              ...
              - Token used to authenticate with the API. Can also be specified via K8S_AUTH_API_KEY environment
                variable.
              vars:
                - name: ansible_openshift_api_key
              env:
          ...
          username:
              ...
              - Provide a username for authenticating with the API. Can also be specified via K8S_AUTH_USERNAME
                environment variable.
              vars:
                - name: ansible_openshift_username
              env:
          ...
          password:
              ...
              - Provide a password for authenticating with the API. Can also be specified via K8S_AUTH_PASSWORD
                environment variable.
              vars:
                - name: ansible_openshift_password
              env:
          ...
          cert_file:
              ...
              - Path to a certificate used to authenticate with the API. Can also be specified via K8S_AUTH_CERT_FILE
                environment variable.
              vars:
                - name: ansible_openshift_cert_file
              env:
          ...
          key_file:
              ...
              - Path to a key file used to authenticate with the API. Can also be specified via K8S_AUTH_KEY_FILE
                environment variable.
              vars:
                - name: ansible_openshift_key_file
              env:
          ...
          ssl_ca_cert:
              ...
              vars:
                - name: ansible_openshift_ssl_ca_cert
              env:
          ...
          verify_ssl:
              ...
              type: bool
              vars:
                - name: ansible_openshift_verify_ssl
              env:
